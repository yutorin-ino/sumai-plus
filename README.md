...
| セクション | 内容 |
|---|---|
| ① ファーストビュー | 住宅業界23年・相談窓口コンセプト・LINE優先CTA |
| ② 実績バー | 住宅業界23年・施工実績・満足度98%・相談無料 |
| ③ 選ばれる5つの理由 | 23年経験・住まい全体相談・工事後も対応・地域密着・営業なし |
| ④ 代表の想い | ストーリーセクション（感情訴求） |
| ⑤ 対応リフォーム | キッチン・浴室・トイレ・洗面・内装・外壁・リノベ |
| ⑥ 概算診断バナー | estimator.htmlへの誘導 |
| ⑦ 施工事例 | Before/After形式・費用・工期・お客様の声 |
| ⑧ 空気まで考える住まい | 断熱・換気・空気環境・省エネ |
| ⑨ お客様の声 | 星評価・レビュー・Google口コミ導線 |
| ⑩ ご相談の流れ | 6ステップ（問い合わせ〜アフターフォロー） |
| ⑪ 代表メッセージ | 井ノ口裕之 |
| ⑫ お問い合わせ | LINE強化CTA（写真送付・24h・相見積もり歓迎・営業なし） |
| ⑬ フッター | 対応エリア明記・SNS |
